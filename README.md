...
This repository contains my implementation for the **Virtual Verse Studio internship task** using Unity 3D. It includes a complete Unity project demonstrating the required 3D configuration and functionality as specified in the assessment brief. :contentReference[oaicite:1]{index=1}
...
- Unity 3D project setup with configurations matching the assessment criteria. :contentReference[oaicite:2]{index=2}
- Scripts written in C# to implement core gameplay or interaction mechanics.
...
1. **Install Unity** (recommended version is the one specified in the ProjectSettings or within the provided PDF).
